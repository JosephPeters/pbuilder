...
editableItems['.modal-content:not(.modalVideo .modal-content)'] = ['background-image', 'background-color', 'background-repeat', 'background-size', 'border-radius'];
editableItems['.modal-content .close'] = ['color', 'font-size', 'opacity'];
...
editableItemOptions['h1 : font-family'] = ['default', 'Lato', 'Helvetica', 'Arial', 'Times New Roman', 'Oswald', 'Dosis', 'Josefin Sans', 'Lobster', 'Parisienne', 'Nothing You Could Do'];
editableItemOptions['h2 : font-family'] = ['default', 'Lato', 'Helvetica', 'Arial', 'Times New Roman', 'Oswald', 'Dosis', 'Josefin Sans', 'Lobster', 'Parisienne', 'Nothing You Could Do'];
editableItemOptions['h3 : font-family'] = ['default', 'Lato', 'Helvetica', 'Arial', 'Times New Roman', 'Oswald', 'Dosis', 'Josefin Sans', 'Lobster', 'Parisienne', 'Nothing You Could Do'];
editableItemOptions['h4 : font-family'] = ['default', 'Lato', 'Helvetica', 'Arial', 'Times New Roman', 'Oswald', 'Dosis', 'Josefin Sans', 'Lobster', 'Parisienne', 'Nothing You Could Do'];
editableItemOptions['h5 : font-family'] = ['default', 'Lato', 'Helvetica', 'Arial', 'Times New Roman', 'Oswald', 'Dosis', 'Josefin Sans', 'Lobster', 'Parisienne', 'Nothing You Could Do'];
editableItemOptions['p : font-family'] = ['default', 'Lato', 'Helvetica', 'Arial', 'Times New Roman', 'Oswald', 'Dosis', 'Josefin Sans', 'Lobster', 'Parisienne', 'Nothing You Could Do'];
...
editableItemOptions['.modal-content:not(.modalVideo .modal-content) : background-repeat'] = ['no-repeat', 'repeat', 'repeat-x', 'repeat-y'];
editableItemOptions['.modal-content:not(.modalVideo .modal-content) : background-size'] = ['cover', 'contain', 'auto'];
		...
		beforeStop: function(event, ui){
			...
			if( ui.item.find('.frameCover').size() == 0 ) {
				...
				if( ui.item.find('iframe').size() > 0 ) {//iframe thumbnails
                    ...
                    ui.item.find('iframe').css('background-size', '64px 52px');
				...
				htmlButton = $('<button type="button" class="btn btn-inverse htmlBlock" data-toggle="modal" data-target="#modalHTMLEditor"><i class="fa fa-code"></i> source</button>');
...
function addEventButtonModal(button, modal, wrapper, innerDoc) {
	$(button).on('click', function(e) {
		...
		$(modal).addClass('in');
		$('.modal-backdrop').hide();
		var closeButton = $('<button type="button" class="btn btn-warning pull-right actionButtons close-inner-modal">Close Popup</button>');
	...
	if (modalContactWindow[0] !== undefined) {
		...
		if (ContactSection[0] === undefined) {
			...
			$(modalContactWindow).each(function(index, element){
				if ($(element).attr('id') === 'modalContactSuccess'||$(element).attr('id') === 'modalSubscribeSuccess'||$(element).attr('id') === 'modalSubscribeSuccess2'||$(element).attr('id') === 'modalRentSuccess'||$(element).attr('id') === 'modalBookingSuccess') {
					var showSuccessButton = $('<button type="button" class="btn btn-primary pull-right actionButtons">Open Success Popup</button>');
					$(wrapper).append(showSuccessButton);
					addEventButtonModal(showSuccessButton, element, wrapper, innerDoc);
				} else if ($(element).attr('id') === 'modalContactError'||$(element).attr('id') === 'modalSubscribeError'||$(element).attr('id') === 'modalSubscribeError2'||$(element).attr('id') === 'modalRentError'||$(element).attr('id') === 'modalBookingError') {
					var showErrorButton = $('<button type="button" class="btn btn-primary pull-right actionButtons">Open Error Popup</button>');
					$(wrapper).append(showErrorButton);
					addEventButtonModal(showErrorButton, element, wrapper, innerDoc);
				} else {
					var openModalPopup = $('<button type="buton" class="btn btn-primary pull-right actionButtons">Open Popup</button>');
