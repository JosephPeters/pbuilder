  ...
  <body>
  			...
  			<ul id="pages">
  				<li style="display: none;" id="newPageLI">
  					...
  					<span class="pageButtons">
  						...
  						<a href="" class="fileCopy"><span class="fui-windows"></span></a>
    ...
    <div class="container">
    	...
    	<header class="clearfix" data-spy="affix" data-offset-top="60" data-offset-bottom="200">
		    ...
		    <div class="substrate-header" data-spy="affix" data-offset-top="60" data-offset-bottom="200"></div>
    	</header>
    ...
    <!-- edit HTML popup -->
    <div class="modal fade" id="modalHTMLEditor" tabindex="-1" role="dialog" aria-hidden="true">
	    <div class="modal-dialog">
		    <div class="modal-content">
			    <div class="modal-body">

				    <div class="aceEditor"></div>
			    </div><!-- /.modal-body -->
			    <div class="modal-footer">
				    <button type="button" class="btn btn-danger editCancelButton btn-wide" data-dismiss="modal"><span class="fui-cross"></span> Cancel</button>
				    <button type="button" class="btn btn-primary editSaveButton btn-wide" data-dismiss="modal"><span class="fui-check"></span> Save</button>
			    </div>
		    </div><!-- /.modal-content -->
	    </div><!-- /.modal-dialog -->
	...
	<div id="loader">
		<span>
			<img src="images/loading.gif" width="64" height="52" alt="Loading...">
